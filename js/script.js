...
if (bt_cadastrar) {
  bt_cadastrar.addEventListener("click", function () {
    ...
    let marca = document.getElementById("tipo").value;
    let fornecedor = document.getElementById("device").value;
    let preco_custo = document.getElementById("preco_desenvolvimento").value;
